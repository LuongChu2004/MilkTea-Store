                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarMain">
                        ...
                        <ul class="navbar-nav align-items-center gap-3" style="padding-right: 100px;">
                            ...
                            <li class="nav-item  position-relative menu-wrapper" style="padding: 0px 10px"><a
                                    class="nav-link text-uppercase fw-semibold menu-link" href="#">HOME</a>
                            </li>
                            <!--MENU-->
                            <li class="nav-item position-relative menu-wrapper" ; style="padding: 0px 10px"><a
                                    class="nav-link text-uppercase fw-semibold menu-link" href="apple_mac.php">MENU</a>
                            ...
                            <li class="nav-item  position-relative menu-wrapper" ; style="padding: 0px 10px"><a
                                    class="nav-link text-uppercase fw-semibold menu-link" href="halal.php">HALAL</a>
                            </li>
                            <li class="nav-item  position-relative menu-wrapper" ; style="padding: 0px 10px"><a
