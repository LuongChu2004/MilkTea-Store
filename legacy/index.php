                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <a href="link-to-detail-page-1">
                                    <img src="images/icon/ct1.jpeg" class="d-block w-100" alt="Chương trình 1">
                                </a>
                            </div>
                            <!-- Slide 2 -->
                            <div class="carousel-item">
                                <a href="link-to-detail-page-2">
                                    <img src="images/icon/ct4.png" class="d-block w-100 " alt="Chương trình 2">
                                </a>
                            </div>
                            <!-- Slide 3 -->
                            <div class="carousel-item">
                                <a href="link-to-detail-page-3">
                                    <img src="images/icon/ct333.jpeg" class="d-block w-100 " alt="Chương trình 3">
                                </a>
                            </div>
                        </div>
                        <!-- Điều hướng carousel -->
    ...
    <section class="hero-section">
        <div class="overlay">
            <div class="content text-center text-white">
                ...
                <a href="/stores" class="btn-learn">Learn More</a>
            </div>
        </div>
    </section>
    <style>
        ...
        .hero-section {
            ...
            height: 100vh;
            /* full màn hình */
            background-image: url('/Chagge_Store/images/bg/HS_TS_la_cua_VietNam.jpg');
            display: flex;
            align-items: center;
            justify-content: center;
        }
