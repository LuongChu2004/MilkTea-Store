        ...
        <header>
            <nav class="navbar navbar-expand-lg ">
                <div class="container d-flex align-items-center justify-content-between">
                    ...
                    <a href="/Chagge_Store/index.php" style="text-decoration: none; color: #333;padding-left: 0px !important;"><b
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarMain">
                        ...
                        <ul class="navbar-nav align-items-center gap-3" style="padding-right: 100px;">
                            ...
                            <li class="nav-item  position-relative menu-wrapper" style="padding: 0px 10px"><a
                                    class="nav-link text-uppercase fw-semibold menu-link" href="/Chagge_Store/index.php">HOME</a>
                            </li>
                            <!--MENU-->
                            <li class="nav-item position-relative menu-wrapper" ; style="padding: 0px 10px"><a
                                    class="nav-link text-uppercase fw-semibold menu-link" href="/Chagge_Store/thucdon.php">MENU</a>
                                    ...
                                    <div class="submenu">
                                        <ul>
                                            ...
                                            foreach ($chunks as $chunk) {
                                                echo '<ul>';
                                                foreach ($chunk as $c) {
                                                    echo '<li class="li-row"><a class="text-uppercase fw-semibold" href="thucdon.php?id_category=' . $c['id'] . '">'
                            ...
                            <li class="nav-item  position-relative menu-wrapper" ; style="padding: 0px 10px"><a
                                    class="nav-link text-uppercase fw-semibold menu-link" href="/Chagge_Store/halal.php">HALAL</a>
                            </li>
                            <li class="nav-item  position-relative menu-wrapper" ; style="padding: 0px 10px"><a
                ...
                <div style="display: flex; padding-right: 5vw; gap:30px; height: 5vh;">
                    ...
                    <?php if (isset($_COOKIE['username'])): ?>
                        ...
                        <div class="dropdown">
                            <a class="btn btn-outline-primary position-relative rounded-circle p-2 " href="user_infor.php" style="height: 100%; width: 2.1vw;">
