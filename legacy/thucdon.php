...
<main>
    <style>
        ...
        .hero-section {
            ...
            width: 100%;
            height: 83vh;
            background-image: url('/Chagge_Store/images/bg/bg-thucdon-1.png');
            display: flex;
            align-items: center;
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 p-3 sidebar">
                <div class="menu-left" style="width: 100%; padding-left: 30%;">
                    ...
                    <ul class="list-unstyled sidebar">
                        <?php
                        $currentCategory = $_GET['id_category'] ?? '';
                        $sql = "SELECT * FROM category";
                        $categories = executeResult($sql);
                        foreach ($categories as $cate) {
                            $active = ($currentCategory == $cate['id']) ? 'active' : '';
                            echo '<li class="mb-2" style="font-size: 18px;">
                                    <a href="thucdon.php?id_category=' . $cate['id'] . '" 
                                       class="' . $active . '" style="color: #918484ff;">
                                       ' . $cate['name'] . '
                                    </a>
                                  </li>';
                        }
                        ...
                        <li class="mt-4 fw-bold">
                            <a href="thucdon.php?search=" class="text-dark">Search Result</a>
                        </li>
                    </ul>
            ...
            <div class="col-12 col-md-9 p-4">
                ...
                if (isset($_GET['search']) && $_GET['search'] != "") {
                    ...
                    echo '<h3 class="mb-4">Kết quả cho: "' . htmlspecialchars($search) . '"</h3>';
                    $sql = "
                    ...
                    $sqlCate = "SELECT * FROM category WHERE id=$id_category";
                    $cate = executeResult($sqlCate);
                    if ($cate) {
                        echo '<h3 class="mb-4" style="padding-left: 5vw">' . $cate[0]['name'] . '</h3>';
                    }
                ...
                if ($listProduct && count($listProduct) > 0) {
                        ...
                        <div class="card mb-3 shadow-sm product-horizontal" style="width:50vw; margin:0 0 0 5vw;">
                            <div class="row g-0" style=" ">
                                <div class="col-md-4" style="">
                                    <img src="admin/product/' . $item['thumbnail'] . '" class="img-fluid" alt="' . $item['title'] . '">
                                </div>
                                <div class="col-md-8 d-flex flex-column" style="">
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title">' . $item['title'] . '</h5>
                                        <p class="card-text"><span class="badge">' . $price . '</span></p>
                                        <a href="details.php?id=' . $item['id'] . '" class="btn btn-outline-primary mt-auto">Xem chi tiết</a>
                                    </div>
                                </div>
                            </div>
                        </div>
